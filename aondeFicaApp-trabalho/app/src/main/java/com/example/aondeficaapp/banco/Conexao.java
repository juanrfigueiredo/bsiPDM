...
public class Conexao {
        ...
        private Banco sqliteOpenHelper ;

        public Conexao(Context context ) {
            sqliteOpenHelper = new Banco(context) ;
        }
        ...
        public int getMaxPK(String tabela, String chave) {
            ...
            cursor.moveToFirst();
            int id=cursor.getInt(0); cursor.close();
            return id;
        }
        ...
        public int apagarTodos(String tabela) {
            return database.delete(tabela , null, null);
        }
